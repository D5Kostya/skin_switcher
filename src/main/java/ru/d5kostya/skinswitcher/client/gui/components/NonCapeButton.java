...
public class NonCapeButton extends AbstractButton {
    ...
    public NonCapeButton(int x, int y, int width, int height, SkinOption skinOption, String keySkin) {
        super(x, y, width, height, Component.translatable("skin_switcher.select.cape.inactive"));
    ...
    public void onClick(double d, double e) {
        if (skin_switcher.currentSkin == skinOption) skinOption.cape = "";
        skinOption.cape = "";
        skin_switcher.skinOptions.put(keySkin, skinOption);
    }
