...
import ru.d5kostya.skinswitcher.client.gui.components.SkinPresetButton;
...
public class SelectSkinPreset extends Screen {
    ...
    public SelectSkinPreset(Screen parent) {
        super(Component.translatable("skin_switcher.select"));
        this.parent = parent;
    }
    ...
    protected void init() {
        ...
        addRenderableWidget(new ButtonBuilder(Component.translatable("skin_switcher.select.create"), (s) -> AlinLib.MINECRAFT.setScreen(new CreateSkin(this))).setWidth(200).setPosition(width/2-100, height-25).build());
