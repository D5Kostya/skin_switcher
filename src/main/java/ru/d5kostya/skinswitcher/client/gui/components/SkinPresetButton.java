...
import ru.d5kostya.skinswitcher.client.gui.screen.select.EditSkinPreset;
...
public class SkinPresetButton extends AbstractButton {
    ...
    public void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTicks) {
        ...
        // -=-=-=-
        if(skin_switcher.currentSkin == skinOption) guiGraphics.blit(RenderType::guiTextured, GuiUtils.getResourceLocation("textures/gui/sprites/icon/checkmark.png"), getRight()-14, getY()+5, 0f, 0f, 9, 8, 9, 8);
        //
        int scale = size / 45;
